...
def registrationView(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if cd['password'] == cd['confirm_password']:
                ...
                return render(request, "app_name/registration.html", {'form':form,'note':'password must match'})
    else:
    ...
    return render(request, "app_name/registration.html", {'form':form})
...
def positionView(request):
    ...
    return render(request, "app_name/position.html", {'obj':obj})
...
def candidateView(request, pos):
    ...
    if request.method == "POST":
        ...
        if temp.status == False:
            ...
            return render(request, 'app_name/candidate.html', {'obj':obj})
    else:
...
def resultView(request):
    ...
    return render(request, "app_name/result.html", {'obj':obj})
...
def candidateDetailView(request, id):
    ...
    return render(request, "app_name/candidate_detail.html", {'obj':obj})
...
def changePasswordView(request):
    ...
    return render(request, "app_name/password.html", {'form':form})
...
def editProfileView(request):
    ...
    if request.method == "POST":
        ...
        return render(request, "app_name/edite_profile.html", {'form':form})
